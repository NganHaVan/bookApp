...
class CartPage extends React.Component {
  ...
  onDelete = _id => {
    ...
    const index = currentBook.findIndex(cart => {
      return cart._id === _id;
    });
    let cartAfterDelete = [
      ...currentBook.slice(0, index),
      ...
      return (
        <Panel key={bookCart._id}>
          <Row>
            ...
            <Col xs={12} sm={3}>
              <h6>
                Quantity:<Label bsStyle="success">{bookCart.quantity}</Label>
              </h6>
            </Col>
            <Col xs={6} sm={3}>
              <ButtonGroup>
                <Button
                  ...
                  bsSize="small"
                  onClick={() => {
                    this.onDecrement(bookCart._id, bookCart.quantity);
                  }}
                >
                  -
                </Button>
    ...
    return (
      <Panel header="Cart" bsStyle="primary">
        ...
        <Row>
          <Col xs={12}>
            <h6>
              <b>Total:</b> {this.props.totalAmount} Euro
            </h6>
        ...
        <Modal show={this.state.showModal} onHide={this.close}>
          ...
          <Modal.Footer>
            <Col xs={6}>
              <h6>
                <b>Total amount:</b> {this.props.totalAmount} Euro
              </h6>
            </Col>
